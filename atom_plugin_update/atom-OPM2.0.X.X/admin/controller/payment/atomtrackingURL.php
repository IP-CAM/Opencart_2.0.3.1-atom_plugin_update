<?php
class ControllerPaymentAtomtrackingURL extends Controller {
	private $error = array();
    public function transactionTracking($trasactionURL,$merchantId,$merchanttxnId,$amount,$transactionDate){
	$url = $trasactionURL;
	$getFields  = "";
